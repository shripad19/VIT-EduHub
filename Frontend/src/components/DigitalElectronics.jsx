...
//   const returnHome = () => {
//     navigate("/student/entc");
//   };

//   const editpost = async (blog) => {
//     navigate("/student/entc/digital-electronics/editpost", { state: blog });
//   };

//   const deletepost = async (id, password) => {
//     try {
//       const response = await fetch("http://localhost:5000/DEdeletepost", {
//         method: "post",
...
//     try {
//       const response = await fetch("http://localhost:5000/DEfetchpost", {
//         method: "post",
...
//           <h1 className="f2fhomeheader">Digital Electronics Blogs</h1>
//         </div>

//         <div className="maincontainer">
//           <div className="newpostlinkblock">
//             <Link className="newpostlink" to="/student/entc/digital-electronics/newpost">
//               New post
//             </Link>
//           </div>
