...
//     navigate("/student/comp/os/editpost", { state: blog });
//   };

//   const deletepost = async (id, password) => {
//     try {
//       const response = await fetch("http://localhost:5000/osdeletepost", {
//         method: "post",
...
//     try {
//       const response = await fetch("http://localhost:5000/osfetchpost", {
//         method: "post",
...
//     if (selectedBlogId) {
//       deletepost(selectedBlogId, password);
//     }
//     handleModalClose();
//   };
...
//           <h1 className="f2fhomeheader">Operating System Blogs</h1>
//         </div>

//         <div className="maincontainer">
//           <div className="newpostlinkblock">
//             <Link className="newpostlink" to="/student/comp/os/newpost">
//               New post
//             </Link>
//           </div>
...
export default function OperatingSystem() {
  ...
  const verifyPasswordForEdit = async (blog, password) => {
    try {
      const response = await fetch("http://localhost:5000/osfetchpost", {
        method: "post",
  ...
  const handleModalSubmit = (password) => {
    if (selectedBlog) {
      if (modalType === "edit") {
        verifyPasswordForEdit(selectedBlog, password);
